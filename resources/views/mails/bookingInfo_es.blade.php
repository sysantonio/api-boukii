...
@section('body')
    ...
    <p>
        Hola {{ $userName }},
        <br>
        Te enviaremos el siguiente correo para recordarte tu reserva con referencia <strong>{{ $reference }}</strong>, para
        @if (count($courses) == 1)
            el siguiente curso:
        @else
       ...
       @if($key == 'collective' && count($cType))
            <div>
                ...
                <div>
                    ...
                    <li>No alquilamos material ni en la recepción ni en la cima de los remontes mecánicos. Le recomendamos que se dirija a una tienda de deportes cerca de usted o a
                        <a target="_blank" href="https://www.charmeysports.ch/"> Charmey Sports</a>.. Tenga en cuenta que no le recomendamos alquilar material el primer día de cursos colectivos, ya que podría perder la cita de las 9:10 a. m.
                    </li>
                </div>
                <br>
    ...
    <p>
        En caso de cambios o cancelación, agradecemos que nos avises lo antes posible al +41 (0)26 927 55 25.
    </p>
    <p>

        Si el estudiante no se presenta al inicio del curso, el precio del mismo no será reembolsado y el curso no se intercambiará por otro.

    </p>
    <p>
        En caso de enfermedad o accidente, el cliente se compromete a informar de la ausencia lo antes posible, como máximo 1 hora antes del inicio del curso. Este podrá ser aplazado o reembolsado solo si se eligió la opción de reembolso al realizar la reserva. Esta opción solo se puede agregar dentro de las 24 horas posteriores a la reserva, por correo electrónico a la dirección ess@charmey.ch.

    </p>

    Si un curso debe ser cancelado, por ejemplo, debido al cierre del teleférico, te informaremos por SMS. Hacemos todo lo posible para reubicar los cursos en la estación de Jaun, a 10 minutos en coche de la salida del pueblo de Charmey.

    <p>
        ¡Gracias por tu inscripción y esperamos darle la bienvenida!
    </p>
    <p>
